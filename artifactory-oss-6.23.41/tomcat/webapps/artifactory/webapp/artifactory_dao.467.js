	        ...
	        findNodeByFullPath: {
	            value: function findNodeByFullPath(path) {
	                ...
	                path = path.map(function (pathElement) {
	                    return _.trimEnd(pathElement, ARCHIVE_MARKER);
	                });
	                if (!path.length) {
	            ...
	            value: function findNodeByPath(path, startIndex) {
	                ...
	                return this.getChildren(true, null, path[startIndex]).then(function (children) {
	                    ...
	                    while (startIndex != path.length) {
	                        ...
	                        var child = _.find(children, { path: partialPath }) || _.find(children, { path: partialPath + "/" });
	                        if (child) {
	                            return child;
	                        }
	                    }
	            ...
	            value: function load() {
	                ...
	                if (this.tabs || this.actions) {
	                    ...
	                    return this.artifactoryHttpClient.post(this.RESOURCE.TREE_BROWSER + "/tabsAndActions", data).then(function (response) {
	                        ...
	                        var removeIndex = _this.actions.indexOf(_.find(_this.actions, { name: "NativeBrowser" }));
	                        if (removeIndex !== -1) {
	                            _this.actions.splice(removeIndex, 1);
	                        }
	
	                        var index = _this.actions.indexOf(_.find(_this.actions, { name: "Watch" }));
	                        if (index === -1) {
	                            index = _this.actions.indexOf(_.find(_this.actions, { name: "Unwatch" }));
	                        }
	                        if (index === -1) {
	                            index = _this.actions.indexOf(_.find(_this.actions, { name: "Move" }));
	                        }
	                        if (index === -1) {
	                            index = _this.actions.indexOf(_.find(_this.actions, { name: "Refresh" }));
	                        }
	                        ...
	                        var distAction = _.find(_this.actions, { name: "Distribute" });
	...
	function RepositoriesDao(RESOURCE, ArtifactoryDaoFactory) {
	    return ArtifactoryDaoFactory().setPath(RESOURCE.REPOSITORIES).setCustomActions({
	        ...
	        isType: function isType() {
	            ...
	            return this.typeSpecific && this.typeSpecific.repoType && _.includes(types, this.typeSpecific.repoType.toLowerCase());
	        },
...
/***/ (function(module, exports) {
	...
	exports.StorageSummaryCachedDao = StorageSummaryCachedDao;
	Object.defineProperty(exports, "__esModule", {
	    value: true
	});
	
	function StorageSummaryCachedDao(RESOURCE, ArtifactoryDaoFactory) {
	    return ArtifactoryDaoFactory().setPath(RESOURCE.STORAGE_SUMMARY + "/:action/:status").setCustomActions({
	        getStorageInfo: {
	            method: "GET" },
	        ...
	        fetchStatus: {
	            method: "GET",
	            params: { action: "refresh", status: "status" }
	        }
	    }).getInstance();
	}
...
//# sourceMappingURL=artifactory_dao.js.467.map