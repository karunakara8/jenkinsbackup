...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ApiConstants = _interopRequire(__webpack_require__(98));
	
	var ArtifactoryCookies = __webpack_require__(150).ArtifactoryCookies;
	
	var ArtifactoryHttpClient = __webpack_require__(151).ArtifactoryHttpClient;
	
	var ArtifactoryStorage = __webpack_require__(152).ArtifactoryStorage;
	
	var ArtifactoryXmlParser = __webpack_require__(153).ArtifactoryXmlParser;
	
	var KeyboardShortcutsModalService = _interopRequire(__webpack_require__(154));
	
	var UserFactory = __webpack_require__(157).UserFactory;
	
	var ArtifactoryState = __webpack_require__(158).ArtifactoryState;
	
	var artifactorySessionInterceptor = __webpack_require__(159).artifactorySessionInterceptor;
	
	var artifactoryDebugInterceptor = __webpack_require__(160).artifactoryDebugInterceptor;
	
	var artifactorySpinnerInterceptor = __webpack_require__(161).artifactorySpinnerInterceptor;
	
	var artifactoryMessageInterceptor = __webpack_require__(162).artifactoryMessageInterceptor;
	
	var artifactoryServerErrorInterceptor = __webpack_require__(163).artifactoryServerErrorInterceptor;
	
	var ArtifactoryModelSaverFactory = __webpack_require__(164).ArtifactoryModelSaverFactory;
	
	var ArtifactoryFeatures = __webpack_require__(165).ArtifactoryFeatures;
	
	var GoogleAnalytics = __webpack_require__(166).GoogleAnalytics;
	
	var NativeBrowser = __webpack_require__(167).NativeBrowser;
	
	var ArtifactActions = __webpack_require__(168).ArtifactActions;
	
	var SetMeUpModal = __webpack_require__(171).SetMeUpModal;
	
	var ArtifactoryDeployModal = __webpack_require__(174).ArtifactoryDeployModal;
	
	var PushToBintrayModal = __webpack_require__(175).PushToBintrayModal;
	
	var parseUrl = __webpack_require__(176).parseUrl;
	
	var recursiveDirective = __webpack_require__(177).recursiveDirective;
	
	var ArtifactorySidebarDriver = __webpack_require__(178).ArtifactorySidebarDriver;
	
	var OnBoardingWizard = __webpack_require__(179).OnBoardingWizard;
	
	var SaveArtifactoryHaLicenses = __webpack_require__(180).SaveArtifactoryHaLicenses;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _keyboard_shortcuts_serviceConstants = __webpack_require__(155);
	    ...
	    showhSortcutsModal: {
	      ...
	      value: function showhSortcutsModal() {
	        ...
	        if (!$(".shortcuts-modal").length) {
	          this.modalInstance = this.modal.launchModalWithTemplateMarkup(__webpack_require__(156), this.modalScope, 800, false);
	        }
	      }
	    }
	  });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var SNIPPETS = _interopRequire(__webpack_require__(172));
	
	var SNIPPETS_JCR = _interopRequire(__webpack_require__(173));
	        ...
	        _initDeploy: {
	            ...
	            value: function _initDeploy() {
	                ...
	                this.repoDataDao.get({ deploy: "true" }).$promise.then(function (result) {
	                    ...
	                    if (_this.node) {
	                        _this.comm.localRepo = _.find(_this.comm.reposList, { repoKey: _this.node.data.repoKey });
	        ...
	        show: {
	            value: function show() {
	                ...
	                whenReady.then(function () {
	                    ...
	                    var icons = [];
	                    var iconsPreloadObj = [];
	                    var _initStatus = _this.initStatus;
	                    var hasDefaultPassword = _initStatus.hasDefaultPassword;
	                    var eulaConfirmed = _initStatus.eulaConfirmed;
	                    var hasPriorLogins = _initStatus.hasPriorLogins;
	                    var hasProxies = _initStatus.hasProxies;
	                    var newsletterFilled = _initStatus.newsletterFilled;
	                    var hasLicenseAlready = _initStatus.hasLicenseAlready;
	
	                    var isPasswordChangeRequired = hasDefaultPassword && !_this.features.isAol();
	                    var isEulaStepRequired = _this.features.isJCR() && !eulaConfirmed;
	                    var areSomeMandatoryStepsPending = isEulaStepRequired || isPasswordChangeRequired;
	                    var cancelable = quickSetup || !areSomeMandatoryStepsPending;
	                    ...
	                    if (!quickSetup && isEulaStepRequired) {
	                        steps.push({
	                            ...
	                            id: "eula",
	                            icon: "images/wizard-icons/icon_eula_idle_gif.467.gif",
	                            iconSrcset: "images/wizard-icons/icon_eula_idle_gif@2.467.gif 2x, images/wizard-icons/icon_eula_idle_gif@3.467.gif 3x",
	                            buildIcon: "images/wizard-icons/icon_eula_build_gif.467.gif",
	                            buildIconSrcset: "images/wizard-icons/icon_eula_build_gif@2.467.gif 2x, images/wizard-icons/icon_eula_build_gif@3.467.gif 3x",
	                    ...
	                    if (!quickSetup && _this.features.isJCR() && !newsletterFilled) {
	                        steps.push({
	                            name: "Sign for Updates",
	                            id: "newsletter",
	                            icon: "images/wizard-icons/icon_subscribe_idle_gif.467.gif",
	                            iconSrcset: "images/wizard-icons/icon_subscribe_idle_gif@2.467.gif 2x, images/wizard-icons/icon_subscribe_idle_gif@3.467.gif 3x",
	                            buildIcon: "images/wizard-icons/icon_subscribe_build_gif.467.gif",
	                            buildIconSrcset: "images/wizard-icons/icon_subscribe_build_gif@2.467.gif 2x, images/wizard-icons/icon_subscribe_build_gif@3.467.gif 3x",
	                    ...
	                    if (!quickSetup && !hasLicenseAlready && !_this.features.isAol() && !_this.features.isNonCommercial()) {
	                        steps.push({
	                            name: "Activate Your Artifactory Instance",
	                            id: "license",
	                            icon: "images/wizard-icons/icon_1_idle_gif.467.gif",
	                            iconSrcset: "images/wizard-icons/icon_1_idle_gif@2.467.gif 2x, images/wizard-icons/icon_1_idle_gif@3.467.gif 3x",
	                            buildIcon: "images/wizard-icons/icon_1_build_gif.467.gif",
	                            buildIconSrcset: "images/wizard-icons/icon_1_build_gif@2.467.gif 2x, images/wizard-icons/icon_1_build_gif@3.467.gif 3x",
	                    ...
	                    if (!quickSetup && !_this.user.isAdmin() && hasPriorLogins) {
	                        steps.push({
	                            name: "Admin Login",
	                            id: "login",
	                            icon: "images/wizard-icons/icon_2_idle_gif.467.gif",
	                            iconSrcset: "images/wizard-icons/icon_2_idle_gif@2.467.gif 2x, images/wizard-icons/icon_2_idle_gif@3.467.gif 3x",
	                            buildIcon: "images/wizard-icons/icon_2_build_gif.467.gif",
	                            buildIconSrcset: "images/wizard-icons/icon_2_build_gif@2.467.gif 2x, images/wizard-icons/icon_2_build_gif@3.467.gif 3x",
	                    ...
	                    var isFirstNonAdminLogin = !_this.user.isAdmin() && !hasPriorLogins;
	                    if (!quickSetup && (isPasswordChangeRequired || isFirstNonAdminLogin)) {
	                        ...
	                        steps.push({
	                            ...
	                            skippable: _this.features.isAol(),
	                            supportReturnTo: true
	                        });
	                    }
	
	                    if (!quickSetup && !_this.features.isAol() && !hasProxies) {
	                        steps.push({
	                            name: "Configure a Proxy Server",
	                            id: "proxy",
	                            icon: "images/wizard-icons/icon_3_idle_gif.467.gif",
	                            iconSrcset: "images/wizard-icons/icon_3_idle_gif@2.467.gif 2x, images/wizard-icons/icon_3_idle_gif@3.467.gif 3x",
	                            buildIcon: "images/wizard-icons/icon_3_build_gif.467.gif",
	                            buildIconSrcset: "images/wizard-icons/icon_3_build_gif@2.467.gif 2x, images/wizard-icons/icon_3_build_gif@3.467.gif 3x",
	                    ...
	                    steps.push({
	                        ...
	                        id: "packageTypes",
	                        icon: "images/wizard-icons/icon_4_idle_gif.467.gif",
	                        iconSrcset: "images/wizard-icons/icon_4_idle_gif@2.467.gif 2x, images/wizard-icons/icon_4_idle_gif@3.467.gif 3x",
	                        buildIcon: "images/wizard-icons/icon_4_build_gif.467.gif",
	                        buildIconSrcset: "images/wizard-icons/icon_4_build_gif@2.467.gif 2x, images/wizard-icons/icon_4_build_gif@3.467.gif 3x",
	                    ...
	                    steps.push({
	                        ...
	                        id: "summary",
	                        icon: "images/wizard-icons/icon_5_idle_gif.467.gif",
	                        iconSrcset: "images/wizard-icons/icon_5_idle_gif@2.467.gif 2x, images/wizard-icons/icon_5_idle_gif@3.467.gif 3x",
	                        buildIcon: "images/wizard-icons/icon_5_build_gif.467.gif",
	                        buildIconSrcset: "images/wizard-icons/icon_5_build_gif@2.467.gif 2x, images/wizard-icons/icon_5_build_gif@3.467.gif 3x",
	        ...
	        sendPackageTypes: {
	            value: function sendPackageTypes(defer) {
	                ...
	                this.OnboardingDao.createDefaultRepos(payload).$promise.then(function (response) {
	                    if (!_this.quickSetup) {
	                        _this.GoogleAnalytics.trackEvent("Onboarding Wizard", !_this.packageTypes.selectedTypes.length ? "Wizard completed - no repos" : "Wizard completed + repos", _.map(_this.packageTypes.selectedTypes, "text").toString(), _this.packageTypes.selectedTypes.length);
	                    } else {
	                        _this.GoogleAnalytics.trackEvent("Homepage", "Quick repository setup completed + repos", _.map(_this.packageTypes.selectedTypes, "text").toString(), _this.packageTypes.selectedTypes.length);
	                    }
	
	                    _this.summary = { data: response.createdReposByTypes };
	                    var isDockerIncluded = _.filter(response.createdReposByTypes, function (pack) {
	                        return pack.type === "docker";
	                    }).length;
	                    if (isDockerIncluded) {
	                        _this.summary.isDockerIncluded = true;
	                    }
	                    var step = _.find(_this.$wizardCtrl.wizardDefinitionObject.steps, { id: "packageTypes" });
	                    step.supportReturnTo = false;
...
//# sourceMappingURL=artifactory_services.js.467.map